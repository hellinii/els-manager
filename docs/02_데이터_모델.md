...
I-01 ~ I-06과 I-10은 DB 제약으로 강제한다(DOC-010 §8 K-04). I-07·I-08은 교차 행 또는 계약 계층 규칙이므로 애플리케이션이 담당하며 DOC-011 §6의 V-02·V-03·V-12에 대응한다. I-09는 `redemptions`에 소유자 컬럼을 두지 않는 것으로 구조적으로 성립한다 — 소유자는 `els_products.owner_id` 하나뿐이다.
