 ...
 *
 * ## `deriveDisplay()`의 **세 번째 소비자**가 되었다
 *
 ...
 * > 문서에 기록된 판단이다(P4.5 정정).
 *
 * > **「마지막」이 아니었다 (P6 컷 6).** 종전 머리글은 「세 번째이자 **마지막**」이라
 * > 적었는데 같은 화면의 상품별 보기(`ProductScheduleCard.tsx`)가 넷째가 되었다.
 * > **서수를 다시 세지 않는다** — 정본 목록은 `lib/format/derived.ts`의 머리글 표
 * > 하나이고, P4.5가 정정한 것이 정확히 「서수는 소비자가 늘 때마다 낡는다」였다.
 *
